...
#ifndef SPACE_INTERFACES__SRV__DETAIL__SPEED_SET__FUNCTIONS_H_
#define SPACE_INTERFACES__SRV__DETAIL__SPEED_SET__FUNCTIONS_H_
...
/// Initialize srv/SpeedSet message.
/**
...
/// Create srv/SpeedSet message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * space_interfaces__srv__SpeedSet_Request__init().
...
/// Destroy srv/SpeedSet message.
/**
 * It calls
 * space_interfaces__srv__SpeedSet_Request__fini()
...
/// Check for srv/SpeedSet message equality.
/**
...
/// Initialize array of srv/SpeedSet messages.
/**
...
/// Finalize array of srv/SpeedSet messages.
/**
 * It calls
 * space_interfaces__srv__SpeedSet_Request__fini()
...
/// Create array of srv/SpeedSet messages.
/**
 * It allocates the memory for the array and calls
 * space_interfaces__srv__SpeedSet_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SpeedSet messages.
/**
 * It calls
 * space_interfaces__srv__SpeedSet_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SpeedSet message array equality.
/**
...
/// Copy an array of srv/SpeedSet messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * space_interfaces__srv__SpeedSet_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_space_interfaces
...
/**
 * It calls
 * space_interfaces__srv__SpeedSet_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_space_interfaces
...
/**
 * It allocates the memory for the array and calls
 * space_interfaces__srv__SpeedSet_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_space_interfaces
...
/**
 * It calls
 * space_interfaces__srv__SpeedSet_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SPACE_INTERFACES__SRV__DETAIL__SPEED_SET__FUNCTIONS_H_
