...
#ifndef SPACE_INTERFACES__SRV__DETAIL__SWITCH__FUNCTIONS_H_
#define SPACE_INTERFACES__SRV__DETAIL__SWITCH__FUNCTIONS_H_
 ...
 * calls
 * space_interfaces__srv__Switch_Request__init().
...
/**
 * It calls
 * space_interfaces__srv__Switch_Request__fini()
 ...
 * space_interfaces__srv__Switch_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * space_interfaces__srv__Switch_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * space_interfaces__srv__Switch_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_space_interfaces
...
/**
 * It calls
 * space_interfaces__srv__Switch_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_space_interfaces
...
/**
 * It allocates the memory for the array and calls
 * space_interfaces__srv__Switch_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_space_interfaces
...
/**
 * It calls
 * space_interfaces__srv__Switch_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SPACE_INTERFACES__SRV__DETAIL__SWITCH__FUNCTIONS_H_
