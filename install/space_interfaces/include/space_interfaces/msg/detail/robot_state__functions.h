...
#ifndef SPACE_INTERFACES__MSG__DETAIL__ROBOT_STATE__FUNCTIONS_H_
#define SPACE_INTERFACES__MSG__DETAIL__ROBOT_STATE__FUNCTIONS_H_
 ...
 * calls
 * space_interfaces__msg__RobotState__init().
...
/**
 * It calls
 * space_interfaces__msg__RobotState__fini()
 ...
 * space_interfaces__msg__RobotState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * space_interfaces__msg__RobotState__Sequence__fini()
 * on the array,
...
#endif  // SPACE_INTERFACES__MSG__DETAIL__ROBOT_STATE__FUNCTIONS_H_
